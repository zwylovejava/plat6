...
public interface JobService extends BaseService<CltJob,CltJobExample,String>{
     ...
     * @return:
     */
    Integer addTestManager(JobQuery jobQuery)throws Exception;
   ...
   CltJob queryJobByJobId(JobQuery jobQuery)throws Exception;
 ...
 */
  ...
  Integer countJobByManagerId(JobQuery jobQuery)throws Exception;
