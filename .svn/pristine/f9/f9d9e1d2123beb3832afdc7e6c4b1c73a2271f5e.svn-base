...
public class CltJob {
    ...
    public double getPercentFail() {
        if(caseNum!=0){
            ...
            BigDecimal bg = new BigDecimal(this.percentFail);
            this.percentFail = bg.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue();
    ...
    public double getPercentOver() {
        if(caseNum!=0){
            this.percentOver=(overNum*1.0/caseNum)*100;
            BigDecimal bg = new BigDecimal(this.percentOver);
            this.percentOver = bg.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue();
    ...
    public double getPercentSuccess() {
        if(caseNum!=0){
            this.percentSuccess=(successNum*1.0/caseNum)*100;
            BigDecimal bg = new BigDecimal(this.percentSuccess);
            this.percentSuccess = bg.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue();
    ...
    public double getPercentComplete() {
        if(caseNum!=0){
            this.percentComplete=(completeNum*1.0/caseNum)*100;
            BigDecimal bg = new BigDecimal(this.percentComplete);
            this.percentComplete = bg.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue();
    ...
    public double getPercentReady() {
        if(caseNum!=0){
            this.percentReady=(readyNum*1.0/caseNum)*100;
            BigDecimal bg = new BigDecimal(this.percentReady);
            this.percentReady = bg.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue();
