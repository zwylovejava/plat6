...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public ResultInfo<CltUserAndLogin> addUserInfo(UserAndLoginQuery userAndLoginQuery) throws Exception{
    ...
    public ResultInfo<Page<CltUserAndLogin>> queryAllTestMangerList(UserAndLoginQuery userAndLoginQuery) throws Exception {
        ...
        try{
            //调用数据库
            resultInfo =  userFeignClient.queryUserListByRoleCode(userAndLoginQuery);
    ...
    @Override
    public ResultInfo<Page<CltUserAndLogin>> queryUserByRoleCode(UserAndLoginQuery userAndLoginQuery) throws Exception {
