...
public class JobServiceImpl implements JobService {
    ...
    @Override
    public ResultInfo<TestCaseStepData> quryStepDataByCaseId(TestCaseStepQuery testCaseStepQuery) throws Exception {

        CltUtils.printStartInfo(testCaseStepQuery, "serviceImpl countNumCltJobByManagerId");

        long startTime = System.currentTimeMillis();

        ResultInfo<TestCaseStepData> listResultInfo = null;
