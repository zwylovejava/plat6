...
public interface DictionaryFeignClient {
    ...
    //根据typeCode查询明细表
      @RequestMapping(value = "/dictionary/queryCltDictionaryItemByTypeCode", method = RequestMethod.POST, consumes="application/json")
      ResultInfo<List<CltDictionaryItem>> queryCltDictionaryItemByTypeCode(@RequestBody DictionaryItemQuery dictionaryItemQuery);
