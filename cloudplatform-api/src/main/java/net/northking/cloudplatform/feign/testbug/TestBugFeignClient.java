...
public interface TestBugFeignClient {
    ...
    ResultInfo<List<CltTestBug>> queryTestBugByCaseId(@RequestBody  TestBugQuery testBugQuery);
    ...
    //根据批次ID查询缺陷列表
    @RequestMapping(value = "/testbug/queryTestBugByBathId", method = RequestMethod.POST, consumes="application/json")
    public ResultInfo<List<CltTestBug>> queryTestBugByBathId(@RequestBody TestBugQuery testBugQuery);
}
